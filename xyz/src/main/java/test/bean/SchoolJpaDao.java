...
import test.event.StudentCoursePayload;
import test.model.BaseEntity;
import test.model.Course;
import test.model.Person;
import test.model.Student;
import test.model.Teacher;
import test.qualifier.DataRepository;
import test.qualifier.StudentAdded;
import test.qualifier.StudentRemoved;
...
public class SchoolJpaDao implements SchoolDao {
	...
	/* (non-Javadoc)
	 * @see test.bean.SchoolDao#searchStudents(test.bean.SearchCriteria, int, int)
	 */
	@SuppressWarnings("unchecked")
	@Override
